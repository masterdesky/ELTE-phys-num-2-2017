...
Given constants:
- Mass of Earth: $5.9736 \times 10^{24}\ \mathrm{kg}$
- Mass of Moon: $7.349 \times 10^{22}\ \mathrm{kg}$
- Moon's distance in Apogee: $405{,}500\ \mathrm{km}$
- Moon's speed in Apogee: $964\ \frac{\mathrm{m}}{\mathrm{s}}$
- Moon's distance in Perigee : $363{,}300\ \mathrm{km}$
- Moon's speed in the Perigee : $1076\ \frac{\mathrm{m}}{\mathrm{s}}$
- Gravitational constant: $6.67384 \times 10^{-11}\ \mathrm{m}^{3} \mathrm{kg}^{-1} \mathrm{s}^{-2}$
